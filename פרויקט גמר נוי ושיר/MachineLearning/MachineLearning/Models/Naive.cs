...
namespace Classification
{
    class NaiveBayes
    {
        ...
        public void Learn(string[] classNames, string[][] classTexts)
        {
            ...
            {
                sumTextsInClasses[c] = classTexts[c].Length;//שומר כמה טקסטים יש בכל 
        ...
        public void Start(string text)
        {
            ...
            for (int c = 0; c < classes.Length; c++)
            {
                ...
                currentClassScore = Math.Log(sumTextsInClasses[c] / (double)countTexts);//כמה מילים יש בקלאס ספיציפי חלקי כל המילים
